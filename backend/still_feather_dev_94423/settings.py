"""
Django settings for still_feather_dev_94423 project.
...
ROOT_URLCONF = 'still_feather_dev_94423.urls'
...
WSGI_APPLICATION = 'still_feather_dev_94423.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "still_feather_dev_94423 API",
    "DESCRIPTION": "API documentation for still_feather_dev_94423 App",
    "VERSION": "v1",
}
